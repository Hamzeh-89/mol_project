...
if(isset($_POST['submit'])){
    ...
    //$Department = $_POST['Department'];     /* AND admin_dept ='$Department' */ 
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/mollogo.png" alt="MOL">
                            </a>
                        </div>
                        ...
                        <input class="au-input au-input--full" type="email" name="email" placeholder="Email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
<input class="au-input au-input--full" type="password" name="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,32}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
                            </div>
...
<!-- end document-->
 ...
 <div class="form-group">
                            ...
                            <select class="au-input au-input--full" type="select" name="Department" placeholder="Enter Your Department" id="select" required="">
