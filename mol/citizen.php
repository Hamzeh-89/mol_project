            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                               ...
                               <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input id="n" type="number"  name="n_id" placeholder="Enter 10 digit" pattern="[0-9]{10}" class="form-control" required="" onkeydown="javascript: return event.keyCode == 69 ? false : true" oninvalid="this.setCustomValidity('Must Be 10 Digit.')">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input class="au-input au-input--full" type="password" name="citizen_password" placeholder="Add Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,32}" required="" oninvalid="this.setCustomValidity('Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters.')">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="Nationality" id="select" class="form-control" required="">
                                     <option disabled select selected hidden>-- select one --</option>
                    ...
                    <center><div class="card-footer">
                        ...
                        <button name="Next" type="Next" class="btn btn-primary btn-lg">
                            <i class="fa fa-magic" ></i>Next
                        </button>

                        <button class="btn btn-warning btn-lg" type="reset"  value="Reset" onclick="">
